...
const openCreateModal = () => {
    ...
    formPermission.name = null;
}

//Edit Modal
const openEditModal = (permission, index) => {
    isEdit.value = true;
    showModal.value = true;
...
const storePermission = () => {
    try {
        router.post(route("permission.store"), formPermission, {
            onSuccess: () => {
                Swal.fire({
                    toast: true,
                    icon: "success",
...
const updatePermission = () => {
    try {
        router.put(`/dashboard/permission/${formPermission.id}`, formPermission, {
            onSuccess: () => {
                Swal.fire({
                    toast: true,
                    icon: "success",
...
const deletePermission = (id) => {
    router.delete('/dashboard/permission/' + id, {
        onSuccess: () => {
            Swal.fire({
                toast: true,
                icon: "success",
...
<template>
    <Head title="Dashboard Permission" />
                ...
                <fwb-table hoverable>
                    ...
                    <fwb-table-body>
                        ...
                        >
                            ...
                            <fwb-table-cell>{{ permission.name }}</fwb-table-cell>
