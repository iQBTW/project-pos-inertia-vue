            ...
            <div class="w-full px-2 bg-gray-300/50 min-h-screen pt-2">
                <fwb-table hoverable>
                    <fwb-table-head>
                        ...
                        <fwb-table-head-cell class="text-center">Stock</fwb-table-head-cell>
                        <fwb-table-head-cell class="text-center">Price</fwb-table-head-cell>
                        <fwb-table-head-cell class="text-center">Category</fwb-table-head-cell>
                    ...
                    <fwb-table-body>
                        ...
                        >
                            ...
                            <fwb-table-cell class="text-center">{{ product.name }}</fwb-table-cell>
                            <fwb-table-cell class="text-center">{{ product.stock }}</fwb-table-cell>
                            <fwb-table-cell class="text-center">{{ product.price }}</fwb-table-cell>
