            ...
            <div class="w-full px-2 bg-gray-300/50 min-h-screen pt-2">
                <fwb-table hoverable>
                    <fwb-table-head>
                        ...
                        <fwb-table-head-cell class="text-center">Email</fwb-table-head-cell>
                        <fwb-table-head-cell class="text-center">Address</fwb-table-head-cell>
                    ...
                    <fwb-table-body>
                        ...
                        >
                            ...
                            <fwb-table-cell class="text-center">{{ user.name }}</fwb-table-cell>
                            <fwb-table-cell class="text-center">{{ user.email }}</fwb-table-cell>
                            <fwb-table-cell class="text-center">{{ user.address }}</fwb-table-cell>
